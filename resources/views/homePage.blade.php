            ...
            <div class="client-logos">
                ...
                @foreach ($spaces as $s)
                    <div style="float:left; margin-left:25px">
                        <img class="cws img-circle" style="margin-bottom:5px" width='150px' height="150px" src="/{{$s->profile_img}}" ><br>
                        <a style="margin-left:80px;margin-top:10px !important;" href="/space/{{$s->id}}"><p>{{$s->name}}</p></a>
