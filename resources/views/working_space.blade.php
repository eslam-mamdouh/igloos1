            ...
            <div class="left-side col-sm-3">
                <div  class="profile-sidebar" style="background-color:#212121;left:0px;">
                    <div class="profile-userpic">
                      <img src="\{{$space->profile_img}}" class="img-circle" alt="" width="50px">
                    </div>
...
<div id ="gallery" >  
  ...
  <br>
  <br>
  <h1 style="margin-bottom:10px; float: left;">{{$space->name}}</h1>
<div class="slider">
...
<br>
  <form name="myform"  onsubmit="return check()" method="POST" action="/reservation">
  @csrf
